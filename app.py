            ...
            <tr>
              <td style="padding:30px">
                ...
                <p style="margin-top:25px;font-weight:bold">
                  ...
                  Iconic Influencer Award London</br>
                  (+44) 2034517166<br/>
                  ...
                  Teigan<br/>
                  Show Director<br/>
                  <a href="mailto:teigan@iconicinfluencerawards.com"
                     style="color:#D7262F">teigan@iconicinfluencerawards.com</a><br/>
...
def send_email(sender_email, sender_password, row, subject, custom_html, cta_text, cta_url):
    try:
        server = smtplib.SMTP("mail.iconicinfluencerawards.com", 587)
        server.starttls()
...
sender_email = st.text_input("Sender Email", value="teigan@iconicinfluencerawards.com")
